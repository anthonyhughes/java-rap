...
package com.datalanguage.javarap.charniak;

import com.datalanguage.javarap.model.ModalAdj;
...
import static com.datalanguage.javarap.utils.Util.*;
...
public class AnnotatedText {
        ...
        if (text != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (sentence.trim().length() > 0) {
                    ...
                    GlobalList.add(analyseTagWordPairs(sentence, new Vector(), sIdx));
    ...
    private void identifyPleonasticPronoun(DefaultMutableTreeNode root) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (tagWd.getTag().equalsIgnoreCase("PRP") && tagWd.getText().equalsIgnoreCase("it")) {
                ...
                if (NPnode == null) {
                    //never happens!
                    errLog("Weird: (PRP it) has no parent");
                    System.exit(0);
                }
                ...
                if (parentNode == null) {
                    //never happens!
                    errLog("Weird: (PRP it) has no grandparent");
                    System.exit(0);
                }
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (tagWd != null) {
                ...
                if (tagWd.getTag().startsWith("N")
                    ...
                    NP aNP = new NP(tagWd.getSentenceIdx(), tagWd.getOffset(),
    ...
    private void buildParseTree() {
        for (int i = 0; i < sents.size(); i++) {
            ...
            rootNode.add(convertSentenceToTreeNode(i, aTaggedSentence, "(", ")"));
        }
    }
